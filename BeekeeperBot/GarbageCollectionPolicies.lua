...
---@alias GarbageCollector fun(droneStackList: AnalyzedBeeStack[], minDronesToClear: integer, target: string): integer[]

---@type GarbageCollector
function M.ClearDronesByFertilityPurityStackSize(droneStackList, minDronesToClear, target)
    local slotsToRemove = {}
