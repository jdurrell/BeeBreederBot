...
function M.HighestPureBredChance(princessStack, droneStackList, target, cacheElement)
    ...
    for _, droneStack in ipairs(droneStackList) do
        ...
        local chance = MatchingMath.CalculateChanceAtLeastOneOffspringIsPureBredTarget(target, princessStack.individual, droneStack.individual, cacheElement)
