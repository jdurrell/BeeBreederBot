...
Res = {}
    Res.MathMargin = 0.001
    Res.MundaneBees = {"Forest", "Marshy", "Meadows", "Modest", "Tropical", "Wintry"}

    -- A graph made up of only mundane bees that breed into Common with 15% chance each.
    Res.BeeGraphMundaneIntoCommon = {}
        Res.BeeGraphMundaneIntoCommon.MutationChanceIndividual = 0.15
        ...
        function Res.BeeGraphMundaneIntoCommon:GetGraph()
            ...
            for i=1, #Res.MundaneBees do
                for j=(i+1), #Res.MundaneBees do
                    AddMutationToGraph(graph, Res.MundaneBees[i], Res.MundaneBees[j], "Common", Res.BeeGraphMundaneIntoCommon.MutationChanceIndividual)
                end
            end
        ...
        Res.BeeGraphMundaneIntoCommon.ExpectedBreedInfo = {
            Forest={},
            Marshy={},
            Meadows={},
            Modest={},
    ...
    Res.BeeGraphMundaneIntoCommonIntoCultivated = {}
        ...
        function Res.BeeGraphMundaneIntoCommonIntoCultivated:GetGraph()
            ...
            for i=1, #Res.MundaneBees do
                AddMutationToGraph(graph, Res.MundaneBees[i], "Common", "Cultivated", 0.12)
            end

            return graph
        end

        Res.BeeGraphMundaneIntoCommonIntoCultivated.ExpectedBreedInfo = {
            Forest={},
            Marshy={},
            Meadows={},
            Modest={},
    ...
    Res.BeeGraphSimpleDuplicateMutations = {}
        ...
        function Res.BeeGraphSimpleDuplicateMutations:GetGraph()
            ...
            AddMutationToGraph(graph, "Root1", "Root2", "Result1", 0.5)
            AddMutationToGraph(graph, "Root1", "Root2", "Result2", 0.2)

            return graph
        end

        Res.BeeGraphSimpleDuplicateMutations.ExpectedBreedInfo = {
            Root1={},
            Root2={},
